...
public class StudyTaskService {
    ...
    public StartStudyTaskResponse startStudyTask(StartStudyTaskRequest startStudyTaskRequest,Long userNumber) {
        StudyTask studyTask = StartStudyTaskRequest.newStudyTask(startStudyTaskRequest);
        User user = userRepository.findById(userNumber).orElseThrow(()-> new UserNotFoundException());
